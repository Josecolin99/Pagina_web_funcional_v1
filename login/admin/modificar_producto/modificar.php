...
<body>
    ...
    <main class="seccion contenedor">
        <h2 class="fw-300 centrar-texto">Modificar</h2>
            ...
            ?>
                <div class="anuncio">
                    ...
                    <div class="contenido-anuncio">
                        ...
                        <a href="modificarinfo.php?id=<?php echo $f['id']; ?>" class="boton boton-amarillo d-block">Ver Propiedad</a>
                    </div>
                </div>
            <?php
            }
        ...
        <div>
            <center>
                ...
                if ($pagina > $total_paginas) {
                    header("Location: modificar.php?pagina=" . $total_paginas);
                }

                //Primeros links
                if ($pagina > $totalpaginas || $pagina <= 0) {
                    echo "<a class='pagina boton bntlink boton-amarillo btnborder' href='modificar.php?pagina=1'>Primera</a>";
                }

                if ($pagina > 1) {
                    echo "<a class='pagina boton bntlink boton-amarillo btnborder' href='modificar.php?pagina=1'>Primera</a>";
                    echo "<a class='pagina boton bntlink boton-amarillo btnborder' href='modificar.php?pagina=" . ($pagina - 1) . "'><<</a>";
                }
                ...
                <span>
                    ...
                    if ($pagina >= $y && $pagina <= $z) {
                        ...
                        for ($i = $rangoinicio; $i <= $rangofin; $i++) {
                            if ($i == $pagina) {
                                echo "<a class='boton bntlink boton-amarillo-select btnborder' href='modificar.php?pagina=" . $i . "'>" . $i . "</a>";
                            } else {
                                echo "<a class='boton bntlink boton-amarillo btnborder' href='modificar.php?pagina=" . $i . "'>" . $i . "</a>";
                            }
                        }
                    } else {
                        $a = 10;
                ...
                if ($pagina < $totalpaginas) {
                    echo "<a class='pagina boton bntlink boton-amarillo btnborder' href='modificar.php?pagina=" . ($pagina + 1) . "'>>></a>";
                    echo "<a class='pagina boton bntlink boton-amarillo btnborder' href='modificar.php?pagina=" . $totalpaginas . "'>Última</a>";
                }
                ?>
