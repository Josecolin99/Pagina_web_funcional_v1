            ...
            ?>
                <fieldset>
                    ...
                    <label>Resumen: <span>*</span>
                        <input type="text" name="resumen" placeholder="Resumen" value=<?php echo $f['resumen']; ?> required>
                    </label>
                    <label>Cuerpo:
                    ...
                    <a href="eliminarconfirma.php?id=<?php echo $id; ?>" class="boton boton-rojo d-block">Eliminar</a>
                <?php } ?>
